! function(t) {
    ...
    var a = n(2),
        s = function(t) {
            ...
            return r(e, t), e.fromArray = function(t, n, i) {
                if (0 !== t.length) {
                    for (var r = new e(t[0], n, i), o = 1; o < t.length; o++) r.insert(t[o]);
                    return r
                }
                ...
                if (!n) return this;
                var i = null;
                if (n !== this || this.parent || (this.parent = new e(this.value, this.cmp, this.eq), this.parent.left = this.withParent(this.parent), i = this.parent), a.assert(void 0 !== n.parent), n.left && n.right) {
                    var r = n.right.leftmostDescendant;
                    n.value = r.value;
                    var o = r.parent;
                    o[l = o.left === r ? "left" : "right"] = r.right, r.right && (r.right.parent = o)
                } else {
                    var s = n.parent,
                        l = s.left === n ? "left" : "right";
                    n.left ? (s[l] = n.left, n.left.parent = n.parent) : (s[l] = n.right, n.right && (n.right.parent = n.parent))
                }
                ...
                if (n) {
                    var i, r;
                    if (e ? (i = "left", r = "rightmostDescendant") : (i = "right", r = "leftmostDescendant"), n[i]) return n[i][r].value;
    ...
    var a = n(1),
        ...
        l = function(t) {
            ...
            return r(e, t), Object.defineProperty(e.prototype, "color", {
                get: function() {
                ...
                if (0 !== t.length) {
                    for (var i = new e(t[0], n), r = 1; r < t.length; r++) i.insert(t[r]);
                    return i
                }
                ...
                var e = t.value,
                    n = t.isRed,
                    i = t.right;
                t.right = i.right, t.right && (t.right.parent = t), i.right = i.left, i.left = t.left, i.left && (i.left.parent = i), t.left = i, t.value = i.value, i.value = e, t.isRed = i.isRed, i.isRed = n
            }, e.prototype.rotateRight = function(t) {
                s.assert(t.left);
                var e = t.value,
                    n = t.isRed,
                    i = t.left;
                t.left = i.left, t.left && (t.left.parent = t), i.left = i.right, i.right = t.right, i.right && (i.right.parent = i), t.right = i.withParent(t), t.value = i.value, i.value = e, t.isRed = i.isRed, i.isRed = n
            }, e.prototype.insertFixup = function(t) {
                for (var e, n = t, i = t;
                    (null === (e = n.parent) || void 0 === e ? void 0 : e.parent) && n.parent.isRed;) {
                    var r;
                    if (n.parent.isLeftChild)(null == (r = n.parent.parent.right) ? void 0 : r.isRed) ? (n.parent.isRed = !1, r.isRed = !1, n.parent.parent.isRed = !0, n = n.parent.parent) : (n.isRightChild && (n = n.parent, this.rotateLeft(n), n.left === i && (i = n), n = n.left), s.assert(n.parent), s.assert(n.parent.parent), n.parent.isRed = !1, n.parent.parent.isRed = !0, this.rotateRight(n.parent.parent), n.parent.right === i && (i = n.parent));
                    else(null == (r = n.parent.parent.left) ? void 0 : r.isRed) ? (n.parent.isRed = !1, r.isRed = !1, n.parent.parent.isRed = !0, n = n.parent.parent) : (n.isLeftChild && (n = n.parent, this.rotateRight(n), n.right === i && (i = n), n = n.right), s.assert(n.parent), s.assert(n.parent.parent), n.parent.isRed = !1, n.parent.parent.isRed = !0, this.rotateLeft(n.parent.parent), n.parent.left === i && (i = n.parent))
                }
                ...
                for (var n, i, r, o, a, l, u, h = t, f = e; h && !(null === (n = h[f]) || void 0 === n ? void 0 : n.isRed);) {
                    var c;
                ...
                if (r)
                    if (o) {
                        if (l = (s = o.leftmostDescendant).isRed, i = s, u = "right", s.parent === n) {
                            var h = i[u];
                            h && (h.parent = s)
                        } else this.transplant(s, s.right), i = s.parent, u = "left", s.right = o.withParent(s);
                        this.transplant(n, s), n === this ? (this.left = r.withParent(this), s.right && (this.right = s.right.withParent(this)), this.isRed = a, i === s && (i = this)) : (s.left = r.withParent(s), s.isRed = a)
                    } else i = n === this ? void 0 : n, u = "left", this.transplant(n, r);
                else {
                    if (i = n === this ? void 0 : n, u = "right", !o && !n.parent) return;
                    o || (i = n.parent, u = n.isLeftChild ? "left" : "right"), this.transplant(n, o)
                }
    ...
    r.Timeline = r.GeoJSON.extend({
        ...
        initialize: function(t, e) {
            ...
            r.GeoJSON.prototype.initialize.call(this, null, e), r.Util.setOptions(this, {
                drawOnSetTime: !0
            }), r.Util.setOptions(this, e), this.options.getInterval && (this._getInterval = function(t) {
                return n.options.getInterval(t)
            }), t && this._process(t)
        },
        _getInterval: function(t) {
            // var startBC = new Date()
            // startBC.setYear("-"+t.properties.start)
            // startBC.setMonth(0)
            // startBC.setDate(1)
            // var endBC = new Date()
            // endBC.setYear("-"+t.properties.end)
            // endBC.setMonth(0)
            // endBC.setDate(1)
            return !!(t.properties && "start" in t.properties && "end" in t.properties) && {
        ...
        _process: function(t) {
            ...
            t.features.forEach((function(t) {
                ...
                r && (e.ranges.insert(r.start, r.end, t), e.times.push(r.start), e.times.push(r.end), n = Math.min(n, r.start), i = Math.max(i, r.end))
            })), this.start = this.options.start || n, this.end = this.options.end || i, this.time = this.start, 0 !== this.times.length && (this.times.sort((function(t, e) {
                return t - e
        ...
        setTime: function(t) {
            this.time = "number" == typeof t ? t : new Date(t).getTime(), this.options.drawOnSetTime && this.updateDisplayedLayers(), this.fire("change")
        },
    ...
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), i(n(8)), i(n(9)), i(n(0)), i(n(1)), i(n(3)), i(n(10))
}, function(t, e, n) {
    "use strict";
    ...
    Object.defineProperty(e, "__esModule", {
        ...
        var s, l, u;
        return void 0 === n && (n = !1), i(this, (function(i) {
            switch (i.label) {
                case 0:
    ...
    var o = function() {
        function t(t, e) {
            ...
            for (var n = Math.floor(this.heap.length / 2) - 1; n >= 0; n--) this.heapify(n)
        }
        return Object.defineProperty(t.prototype, "size", {
            get: function() {
            ...
            for (var e = this.heap.push(t) - 1, n = !0; n;) {
                var i = r(e);
                i >= 0 && this.cmp(t, this.heap[i]) ? (this.swap(e, i), e = i) : n = !1
            }
            return this.size
            ...
            var n;
            n = i([this.heap[e], this.heap[t]], 2), this.heap[t] = n[0], this.heap[e] = n[1]
    ...
    var o = function() {
        ...
        return Object.defineProperty(t.prototype, "size", {
            ...
            if (this.tree) {
                ...
                for (s.left && r(s.left), s.right && r(s.right), r(s); s.parent;) r(s.parent), s = s.parent
            } else this.tree = new i.RBTree(a, (function(t, e) {
                return t.low < e.low
            }), (function(t, e) {
                return t.low === e.low && t.high === e.high && o.eq(t.value, e.value)
            }));
            ...
            for (var e = [], n = [this.tree]; n.length;) {
                var i = n.pop();
                i && (i.value.low <= t && i.value.high >= t && e.push(i.value.value), i.left && i.left.value.max >= t && n.push(i.left), i.right && i.value.low <= t && i.right.value.max >= t && n.push(i.right))
            }
            return e
            ...
            for (var n = [], i = [this.tree]; i.length;) {
                var r = i.pop();
                r && (t <= r.value.high && e >= r.value.low && n.push(r.value.value), r.left && r.left.value.max >= t && i.push(r.left), r.right && r.right.value.max >= t && i.push(r.right))
            }
            return n
        }, t
    }();
    ...
    i.TimelineSliderControl = i.Control.extend({
        initialize: function(t) {
            void 0 === t && (t = {});
            this.timelines = [], i.Util.setOptions(this, {
                duration: 1e4,
                ...
                steps: 1e3,
                autoPlay: !1
            }), i.Util.setOptions(this, t), this.start = t.start || 0, this.end = t.end || 0
        },
        _getTimes: function() {
            var t = this,
                e = [];
        ...
        _recalculate: function() {
            ...
            })), t || (this.start = i, this._timeSlider.min = (i === 1 / 0 ? 0 : i).toString(), this._timeSlider.value = this._timeSlider.min), e || (this.end = r, this._timeSlider.max = (r === -1 / 0 ? 0 : r).toString()), this._stepSize = Math.max(1, (this.end - this.start) / this.options.steps), this._stepDuration = Math.max(1, n / this.options.steps)
        },
        _nearestEventTime: function(t, e) {
            void 0 === e && (e = 1);
            for (var n = this._getTimes(), i = !1, r = n[0], o = 1; o < n.length; o++) {
                var a = n[o];
                if (i) return a;
                if (a >= t) {
                    if (-1 === e) return r;
        ...
        _createDOM: function() {
            var t = i.DomUtil.create("div", ["leaflet-control-layers", "leaflet-control-layers-expanded", "leaflet-timeline-control"].join(" "));
            ...
            this._makeSlider(t), this.options.showTicks && this._buildDataList(t), this.options.autoPlay && this._autoPlay()
        },
        ...
        _buildDataList: function(t) {
            ...
            this._datalist.id = "timeline-datalist-" + e, this._timeSlider.setAttribute("list", this._datalist.id), this._rebuildDataList()
        },
        _rebuildDataList: function() {
            ...
            if (t) {
                ...
                e.setAttribute("aria-label", "List of times"), this._getTimes().forEach((function(t) {
        ...
        _makeButton: function(t, e) {
            ...
            r.setAttribute("aria-label", e), r.addEventListener("click", (function() {
                return n[e]()
            })), i.DomEvent.disableClickPropagation(r)
        },
        _makeButtons: function(t) {
            this._makeButton(t, "prev"), this._makeButton(t, "play"), this._makeButton(t, "pause"), this._makeButton(t, "next")
        },
        ...
        _sliderChanged: function(t) {
            ...
            this.time = e, this.options.waitToUpdateMap && "change" !== t.type || this.timelines.forEach((function(t) {
                return t.setTime(e)
        ...
        _autoPlay: function() {
            var t = this;
            "loading" === document.readyState ? window.addEventListener("load", (function() {
                return t._autoPlay()
            })) : this.play()
        },
        ...
        removeTimelines: function() {
            ...
            var i = this.timelines.length;
            e.forEach((function(e) {
                var n = t.timelines.indexOf(e); - 1 !== n && t.timelines.splice(n, 1)
            })), this._resetIfTimelinesChanged(i)
        },
        toggle: function() {
        ...
        pause: function(t) {
            var e;
            window.clearTimeout(this._timer), this._playing = !1, null === (e = this.container) || void 0 === e || e.classList.remove("playing"), this.syncedControl && !t && this.syncedControl.map((function(t) {
                t.pause(!0)
            }))
        },
        play: function(t) {
            ...
            window.clearTimeout(this._timer), parseFloat(this._timeSlider.value) === this.end && (this._timeSlider.value = this.start.toString()), this._timeSlider.value = (parseFloat(this._timeSlider.value) + this._stepSize).toString(), this.setTime(+this._timeSlider.value), parseFloat(this._timeSlider.value) === this.end ? (this._playing = !1, null === (e = this.container) || void 0 === e || e.classList.remove("playing")) : (this._playing = !0, null === (n = this.container) || void 0 === n || n.classList.add("playing"), this._timer = window.setTimeout((function() {
                return i.play(!0)
            }), this._stepDuration)), this.syncedControl && !t && this.syncedControl.map((function(t) {
                t.play(!0)
            }))
        },
        next: function() {
        ...
        setTime: function(t) {
            this._timeSlider && (this._timeSlider.value = t.toString()), this._sliderChanged({
                type: "change",
                target: {
                    value: t.toString()
                }
        ...
        onRemove: function() {
            this.options.enableKeyboardControls && this._removeKeyListeners(), i.DomEvent.off(this._timeSlider, "change input", this._sliderChanged, this), i.DomEvent.off(this._timeSlider, "pointerdown mousedown touchstart", this._disableMapDragging, this), i.DomEvent.off(document.body, "pointerup mouseup touchend", this._enableMapDragging, this), this._enableMapDragging()
        },
        syncControl: function(t) {
            this.syncedControl || (this.syncedControl = []), this.syncedControl.push(t)
        }
        ...
        for (var n = {}, i = [], r = 0; r < t.length; r++) {
            ...
            var f = s(h),
                c = {
                    ...
                    media: o[2],
                    sourceMap: o[3]
                }; - 1 !== f ? (a[f].references++, a[f].updater(c)) : a.push({
                identifier: h,
                updater: g(c, e),
                references: 1
            }), i.push(h)
    ...
    function g(t, e) {
        ...
        if (e.singleton) {
            var o = v++;
            n = d || (d = u(e)), i = c.bind(null, n, o, !1), r = c.bind(null, n, o, !0)
